...
urlpatterns = [
    ...
    path('submit_ticket/<int:enrollment_id>/', views.submit_ticket, name='submit_ticket'),
    ...
    path('your_enrollments/', views.YourEnrollmentsView.as_view(), name = 'your_enrollments'),
    path('invoice/<int:enrollment_id>/', views.InvoiceView.as_view(), name= 'invoice'),


    #Tutor views
    path('tutor_enrollments', views.TutorEnrollmentList.as_view(), name= 'tutor_enrollments'),
]
